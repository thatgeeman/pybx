...
Docs: https://thatgeeman.github.io/pybx/utils.html.md"""

# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/02_utils.ipynb.

# %% auto #0
__all__ = ['get_edges', 'validate_boxes', 'as_tuple', 'reassign_label']

# %% ../nbs/02_utils.ipynb #bc7c1546
import inspect

import numpy as np

from .ops import __ops__, get_op
from .basics import get_bx, BaseBx

from fastcore.foundation import L


# %% ../nbs/02_utils.ipynb #f44b2354
...
def validate_boxes(coords, image_sz, feature_sz, clip=True, min_visibility=0.25):
    ...
    if clip:
        coords[:, [0, 2]] = coords[:, [0, 2]].clip(0, image_width)
        coords[:, [1, 3]] = coords[:, [1, 3]].clip(0, image_height)
    # make the boxes int
