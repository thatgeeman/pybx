...
def get_gt_thresh_iou(
    ...
    Returns:
        dict: positive ground truth anchors keyed by box ID
        dict: IOUs of positive ground truth anchors keyed by box ID
        dict: boolean masks indicating positive anchors keyed by box ID
    """
    gt_anchors_per_box = {}
    iou_per_box = {}
    mask_per_box = {}
    ...
    return gt_anchors_per_box, iou_per_box, mask_per_box
