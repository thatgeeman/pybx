...
Docs: https://thatgeeman.github.io/pybx/vis.html.md"""

# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/05_vis.ipynb.
...
from .basics import *
from .anchor import bx
from .ops import voc_keys
from .sample import get_example, get_given_array


def _require_matplotlib():
    """Import Matplotlib only when a visualization is requested."""
    try:
        patches = importlib.import_module("matplotlib.patches")
        patheffects = importlib.import_module("matplotlib.patheffects")
        pyplot = importlib.import_module("matplotlib.pyplot")
    except ImportError as exc:
        raise ImportError(
            "Matplotlib is required for visualization. "
            "Install it with `pip install 'pybx[viz]'`."
        ) from exc
    return patches, patheffects, pyplot


# %% ../nbs/05_vis.ipynb #f3b3b005
def draw_outline(obj, linewidth: int):
    ...
    :return: plt object
    """
    _, patheffects, _ = _require_matplotlib()
...
def draw_rectangle(ax, coords, color="white"):
    ...
    :return: ax object
    """
    patches, _, _ = _require_matplotlib()
    x1, y1, x2, y2 = coords
    w, h = x2 - x1, y2 - y1
    patch = ax.add_patch(
