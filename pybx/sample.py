...
Docs: https://thatgeeman.github.io/pybx/sample.html.md"""

# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/04_sample.ipynb.

# %% auto #0
__all__ = ["get_example", "get_given_array"]

# %% ../nbs/04_sample.ipynb #6f853336
import importlib
import inspect
import json
import os
...
def _require_cv2():
    """Import OpenCV only when image loading or resizing needs it."""
    try:
        return importlib.import_module("cv2")
    except ImportError as exc:
        raise ImportError(
            "OpenCV is required for image loading and resizing. "
            "Install it with `pip install 'pybx[opencv]'`."
        ) from exc


# %% ../nbs/04_sample.ipynb #f451e0c3
__all__ = ["get_example", "get_given_array"]


# %% ../nbs/04_sample.ipynb #f5f2bfd8
...
def _get_example(
    ...
    assert len(image_sz) == 2, f"{inspect.stack()[0][3]} of {__name__}: \
